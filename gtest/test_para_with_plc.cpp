...
TEST(Test_para_with_plc,temp1){
    ...
    ASSERT_EQ(paraTemp1.getResVal_DWORD()[0],0);
    ASSERT_EQ(paraTemp1.getResVal_DWORD()[1],1100);
    Para_with_plc paraTemp2("温度2高位报警",TreatmentMethod::x10,120);
    ASSERT_EQ(paraTemp2.getResVal_DWORD()[0],0);
    ASSERT_EQ(paraTemp2.getResVal_DWORD()[1],1200);
}
